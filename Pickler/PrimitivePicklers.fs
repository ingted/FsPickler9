...
type StringPickler () =
    ...
    //20221115 replace with new cloned repo
    //override __.Clone (_ : CloneState) (s : string) = if isNull s then s else new System.String(s.ToCharArray())
    override __.Clone (_ : CloneState) (s : string) = if isNull s then s else System.String.Copy s
