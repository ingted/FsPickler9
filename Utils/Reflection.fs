...
let implementsIEnumerableOfT (typ: Type) =
    // 檢查該類型是否實現了泛型 IEnumerable<>
...
let isGenericEnumerable(t : Type) =
    t.GetGenericTypeDefinition () = typedefof<Microsoft.FSharp.Collections.seq<_>> || implementsIEnumerableOfT t
